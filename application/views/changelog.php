    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2 search_container">
        ...
        <div class="container-fluid">
            <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
                <ul>
                    <li>- Re-wrote the entire backend to be more understandable/adaptable for future users</li>
                    <li>- Master clues are now in!</li>
                    <li>- The project has been moved to github! report bugs/add to the project yourself!</li>
                </ul>
            </div>
        </div>
        <h3>20/09/2015</h3>
        <div class="container-fluid">
            <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
                <ul>
                    <li>- Added minor ads, If this is making you not want to come back to the site, please let me know</li>
                </ul>
            </div>
        </div>
        <h3>09/06/2015</h3>
