...
<div class="container component_contianer">
    <div class="col-xs-12 col-md-8 col-md-offset-2 search_container">
        ...
        <div class="input-group">
          ...
          <input id="autocomplete" type="text" class="form-control" aria-label="..." data-provide="typeahead">
        </div><!-- /input-group -->
        <div class="container-fluid">
            <div class="col-xs-10 col-xs-offset-1">
                <div class="alert alert-success" role="alert" style="margin-top:30px;">
                    ...
                    <br>
                    The whole site has been rebuilt again, i apologise profusely for this downtime, it <b>shouldn't</b> ever happen again<br><br>
